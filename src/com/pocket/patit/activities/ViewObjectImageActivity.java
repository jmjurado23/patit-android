...
/**
 * {@link ViewObjectImageActivity}
 * 
 * Clase que muestra un objeto de tipo imagen. Esta clase tiene sus particularidades
 * por lo que se decidió no hacer una herencia con los otros tipos de objetos. Ésta realiza
 * una conexión para cargar la imagen a partir de la dirección que nos da el objeto
 * 
 * @author Juan Manuel Jurado
 * @author <jmj23elviso@gmail.com>
 * @version 1.0
 */
public class ViewObjectImageActivity extends Activity implements OnTouchListener,OnClickListener{

	private Object obj;						//objeto a mostrar
	private CheckedTextView Name;			//nombre de la imagen
	private TextView URL;					//url de la imagen
	private WebView webView;				//vista de la imagen
	private Handler handlerInfo;			//manejador de la información
	private LinearLayout info;				//layout con la info de la imagen
	private RelativeLayout webViewRela;		//webView de la imagen
	private LoadingObjectFragment fragment;	//fragmento que mostrará la carga de la imagen
	private int parent;						//padre
	private int n_pocket_parent;			//número del bolsillo al que pertenece el obj
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_object_image);
        ...
        if(obj!=null){ //si el objeto existe
        	...
        	//se definen los parámetros de objeto
        	...
        	//se definen los parámetros para mostrar a la imagen centrada
        	...
        	String HTML_FORMAT = "<html><body><img src=\"%s\" width=\""+ 1024+"px\"></body></html>";
        	final String html = String.format(HTML_FORMAT, obj.getUrl());
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case android.R.id.home: //botón de bolsillo superior
		...
		case R.id.saveicon: //botón de guardar elemento
	    	...
	    	// Se crea un mensaje para la información a enviar
		...
		case R.id.descicon: //botón para ver los detalles del objeto
