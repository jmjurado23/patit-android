...
/**
 * {@link ChargeRandomPocketFromJSON}
 * 
 * Clase que pasa la información de los bolsillos aleatorios a partir de un
 ...
 * @version 1.0
 */
public class ChargeRandomPocketFromJSON {
	...
	List<Pocket> pockets;  //bolsillos aleatorios
	JSONObject json0;	   //JSON que se pasa para sacar la información
	
	public ChargeRandomPocketFromJSON(JSONObject json0) {
	...
	private void chargePockets() {
		...
		try {
			...
			randomArray = json0.getJSONArray(Constants.OBJECTS);
			...
			for(int i=0;i<randomArray.length();i++){
				...
				pocket = randomArray.getJSONObject(i);
